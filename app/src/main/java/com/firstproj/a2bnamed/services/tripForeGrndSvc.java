...
import com.firstproj.a2bnamed.inTripScreen;
 ...
 */
public class tripForeGrndSvc extends Service {
    ...
    public static final String EXTRA_SECS = PACKAGE_NAME + ".seconds";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        // Tells the system to try to recreate the service if its killed accidentally.
        return START_STICKY;
    }
    ...
    public void requestLocationUpdates() {
        ...
        // This is equivalent to starting a trip.
        // Start the timer
    ...
    private Notification getNotification() {
        ...
        PendingIntent activityPendingIntent = PendingIntent.getActivity(this, 0,
                new Intent(this, inTripScreen.class), 0);

        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, "1")
//                .addAction(R.drawable.ic_launcher_background, "mkmkmkm",
//                        activityPendingIntent)
//                .addAction(R.drawable.ic_launcher_foreground, "Wdwdedw",
//                        servicePendingIntent)
                .setContentText("jnjnjnjnjn")
//                .setContentTitle(Utils.getLocationTitle(this))
    ...
    public class LocalBinder extends Binder {
        public tripForeGrndSvc getService() {
            return tripForeGrndSvc.this;
        }
    }
